        ...
        <div class="col-md-4">
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <form action="<?= base_url('Admin/simpanPenjualan') ?>" method="POST" id="formTransaksi">
                        <?= csrf_field() ?>
...
function lihatDetail(id) {
    fetch(`<?= base_url('Admin/laporan/detail/') ?>${id}`)
...
function hapusPenjualan(id) {
    if (confirm('Apakah Anda yakin ingin menghapus data ini?')) {
        window.location.href = `<?= base_url('Admin/hapusPenjualan') ?>${id}`;
    }
}

// Fungsi untuk mencetak struk
function cetakStruk(id) {
    window.open(`<?= base_url('Admin/laporan/cetak/') ?>${id}`, '_blank');
}
...
function filterPenjualan() {
    ...
    window.location.href = `<?= base_url('Admin/laporan/filter') ?>?tanggal_awal=${tanggal_awal}&tanggal_akhir=${tanggal_akhir}&id_produk=${id_produk}`;
}
</script>
